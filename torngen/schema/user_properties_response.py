...
from .user_property_details_extended_for_rent import \
    UserPropertyDetailsExtendedForRent
from .user_property_details_extended_for_sale import \
    UserPropertyDetailsExtendedForSale
from .user_property_details_extended_rented import \
